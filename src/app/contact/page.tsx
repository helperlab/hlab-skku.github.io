            ...
            <main className="flex-grow pt-44 pb-24">
                <div className="container-custom">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 max-w-[980px] mx-auto">
                        ...
                        {/* Google Map Embed */}
                        <div className="bg-gray-100 dark:bg-[#1a1a1a] rounded-[32px] overflow-hidden h-full md:h-full aspect-[4/3] md:aspect-auto shadow-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
                            <iframe
